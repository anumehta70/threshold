...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.attestationIncome) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named attestationIncome');
    }
    ...
    this.circuits = {
      registerIssuer: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerIssuer',
                                     ...
                                     'threshold.compact line 71 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      createListing: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`createListing: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const rentAmount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createListing',
                                     'argument 1 (as invoked from Typescript)',
                                     'threshold.compact line 82 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(rentAmount_0) === 'bigint' && rentAmount_0 >= 0n && rentAmount_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('createListing',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'threshold.compact line 82 char 1',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(rentAmount_0),
      ...
      issueAttestation: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`issueAttestation: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const attestationId_0 = args_1[1];
        const issuerId_0 = args_1[2];
        const applicantAddress_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('issueAttestation',
                                     'argument 1 (as invoked from Typescript)',
                                     'threshold.compact line 99 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(attestationId_0.buffer instanceof ArrayBuffer && attestationId_0.BYTES_PER_ELEMENT === 1 && attestationId_0.length === 32)) {
          __compactRuntime.typeError('issueAttestation',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'threshold.compact line 99 char 1',
                                     'Bytes<32>',
        ...
        if (!(applicantAddress_0.buffer instanceof ArrayBuffer && applicantAddress_0.BYTES_PER_ELEMENT === 1 && applicantAddress_0.length === 32)) {
          __compactRuntime.typeError('issueAttestation',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(attestationId_0).concat(_descriptor_0.toValue(issuerId_0).concat(_descriptor_0.toValue(applicantAddress_0))),
        ...
        const result_0 = this._issueAttestation_0(context,
                                                  partialProofData,
                                                  attestationId_0,
                                                  issuerId_0,
                                                  applicantAddress_0);
      ...
      submitProof: (...args_1) => {
        ...
        const attestationId_0 = args_1[2];
        const multiplier_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submitProof',
                                     'argument 1 (as invoked from Typescript)',
                                     'threshold.compact line 122 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(multiplier_0) === 'bigint' && multiplier_0 >= 0n && multiplier_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('submitProof',
                                     'argument 3 (argument 4 as invoked from Typescript)',
                                     'threshold.compact line 122 char 1',
                                     'Uint<0..18446744073709551616>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(listingId_0).concat(_descriptor_0.toValue(attestationId_0).concat(_descriptor_2.toValue(multiplier_0))),
  ...
  _callerSecretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('callerSecretKey',
                                 'return value',
                                 'threshold.compact line 61 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _attestationIncome_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.attestationIncome(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('attestationIncome',
                                 'return value',
                                 'threshold.compact line 62 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _attestationSalt_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
  ...
  _derivePublicKey_0(secret_0) {
    return this._persistentHash_1([secret_0, secret_0]);
  }
  _createListing_0(context, partialProofData, rentAmount_0) {
    const landlordId_0 = this._derivePublicKey_0(this._callerSecretKey_0(context,
                                                                         partialProofData));
    const listingId_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_10.toValue(3n),
                                                                  alignment: _descriptor_10.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(listingId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(rentAmount_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(listingId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(landlordId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_0 = 0n;
                      ...
                      applicantAddress_0)
  {
    ...
    const income_0 = this._attestationIncome_0(context, partialProofData);
    const salt_0 = this._attestationSalt_0(context, partialProofData);
    const commitment_0 = this._persistentHash_0([__compactRuntime.convertFieldToBytes(32,
                                                                                      income_0,
                                                                                      'threshold.compact line 111 char 7'),
                                                 applicantAddress_0,
                                                 salt_0]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_10.toValue(6n),
                                                                  alignment: _descriptor_10.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(attestationId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                 ...
                 multiplier_0)
  {
    const income_0 = this._attestationIncome_0(context, partialProofData);
    const salt_0 = this._attestationSalt_0(context, partialProofData);
    const applicantAddress_0 = this._derivePublicKey_0(this._callerSecretKey_0(context,
                                                                               partialProofData));
    const storedCommitment_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                         ...
                                                                                         [
                                                                                          ...
                                                                                          { idx: { cached: false,
                                                                                                   ...
                                                                                                   path: [
                                                                                                          { tag: 'value',
                                                                                                            value: { value: _descriptor_0.toValue(attestationId_0),
                                                                                                                     alignment: _descriptor_0.alignment() } }] } },
                                                                                          { popeq: { cached: false,
                                                                                                     result: undefined } }]).value);
    const recomputed_0 = this._persistentHash_0([__compactRuntime.convertFieldToBytes(32,
                                                                                      income_0,
                                                                                      'threshold.compact line 133 char 7'),
                                                 applicantAddress_0,
                                                 salt_0]);
    __compactRuntime.assert(this._equal_0(recomputed_0, storedCommitment_0),
                            'attestation does not match this caller');
    const rent_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                             partialProofData,
                                                                             [
                                                                              { dup: { n: 0 } },
                                                                              { idx: { cached: false,
                                                                              ...
                                                                              { idx: { cached: false,
                                                                                       ...
                                                                                       path: [
                                                                                              { tag: 'value',
                                                                                                value: { value: _descriptor_2.toValue(listingId_0),
                                                                                                         alignment: _descriptor_2.alignment() } }] } },
                                                                              { popeq: { cached: false,
                                                                                         result: undefined } }]).value);
    const required_0 = rent_0 * multiplier_0;
    __compactRuntime.assert(income_0 >= required_0,
                            "attested income does not meet this listing's threshold");
    const nullifier_0 = this._persistentHash_1([__compactRuntime.convertFieldToBytes(32,
                                                                                     listingId_0,
                                                                                     'threshold.compact line 142 char 7'),
                                                applicantAddress_0]);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'already submitted a proof for this listing');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const verifiedSoFar_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                       { idx: { cached: false,
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('threshold.compact line 148 char 61: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(verifiedSoFar_0 + 1n);
    __compactRuntime.queryLedgerState(context,
    ...
    listingRentAmount: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 46 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    listingLandlord: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 47 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    listingVerifiedCount: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 48 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    attestationCommitment: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 51 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    attestationIssuer: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 53 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    proofNullifiers: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold.compact line 57 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  ...
  attestationIncome: (...args) => undefined,
